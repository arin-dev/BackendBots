...
class Project(models.Model):
    ...
    equipment_requirements = models.ManyToManyField('equipment.EquipmentRequirement', related_name='projects_set')
    selected_equipments = models.ManyToManyField('equipment.SelectedEquipments', related_name='projects_set')
